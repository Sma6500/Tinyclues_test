"""
This file contains a test for the class similarity_cat, 
I just raise an error in case of dysfunctionnement. A best  
method would be to test each class function and raise an appropriate error.
"""
